...
namespace Gemini.Modules.Shell
{
    public static class ToolBarDefinitions
    {
        ...
        [Export] public static ToolBarItemDefinition OpenFileToolBarItem = new CommandToolBarItemDefinition
        ...
        [Export] public static ToolBarItemDefinition SaveAllFilesToolBarItem = new CommandToolBarItemDefinition
