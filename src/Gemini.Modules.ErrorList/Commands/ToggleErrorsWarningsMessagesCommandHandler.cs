...
namespace Gemini.Modules.ErrorList.Commands
{
        ...
        ICommandHandler<ToggleMessagesCommandDefinition>
    {
        ...
        void ICommandHandler<ToggleErrorsCommandDefinition>.Update(Command command)
        {
            ...
            command.Text =
                command.ToolTip = Pluralize(Resources.ErrorTextSingular, Resources.ErrorTextPlural, ErrorItemCount);
        }
        ...
        void ICommandHandler<ToggleMessagesCommandDefinition>.Update(Command command)
        {
            ...
            command.Text =
                command.ToolTip =
                    Pluralize(Resources.MessageTextSingular, Resources.MessageTextPlural, MessageItemCount);
        }
        ...
        void ICommandHandler<ToggleWarningsCommandDefinition>.Update(Command command)
        {
            ...
            command.Text =
                command.ToolTip =
                    Pluralize(Resources.WarningTextSingular, Resources.WarningTextPlural, WarningItemCount);
        }
